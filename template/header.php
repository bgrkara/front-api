    ...
    ***********************************-->
    <div class="nav-header">
        <a href="./" class="brand-logo">
            <img class="logo-abbr" src="./public/images/shop-logo.svg" alt="">
            <img class="logo-compact" src="./public/images/shop-text.svg" alt="">
            <img class="brand-title" src="./public/images/shop-text.svg" alt="">
        </a>
